	...
	<div class='ayuda'>
		...
		<div class="text-ayuda">
			<div class="section-one">
				...
				<p>Para generar las posiciones hacemos una lista de todas las escuelas del estado, de cada nivel educativo, por sus calificaciones globales. La calificación global de una escuela está basada en un promedio ponderado de sus resultados de matemáticas y español en la prueba ENLACE del último año. Si quieres conocer a detalle la metodología detrás de nuestro sitio te invitamos a leer nuestra ficha metodológica.  (link a: www.mejoratuescuela.org/metodologia)</p>
				<a name='pregunta3'></a>
