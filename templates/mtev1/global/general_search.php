<form action="<?=$this->get("action")=="escuelas"?'/compara/escuelas/?id='.$this->get('id').'-':'/compara/#resultados' ?>" method='<?=$this->get("action")=="escuelasNONE"?'post':'get'?>' accept-charset='utf-8' class='general-search' id='general-search'>
