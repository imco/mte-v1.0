...
class default_config{
        public function __construct(){
                ...
                //MTE
                $this->semaforos = array('Reprobado','De panzazo','Bien','Excelente','No tomÃ³ la <br /> prueba <br />ENLACE','Poco confiable','Esta escuela no tomÃ³ la prueba ENLACE para todos los aÃ±os','La prueba ENLACE no esta disponible para este nivel escolar');
