...
class escuela extends table{
	...
	function get_semaforo(){
		...
		var_dump( $turnos, isset($this->grados) , $this->nivel->nombre != "BACHILLERATO"  , ($this->grados < 4 * $turnos && $this->nivel->nombre == "PRIMARIA"), ($this->grados < 3 * $turnos && $this->nivel->nombre == "SECUNDARIA") );
