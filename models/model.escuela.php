...
class escuela extends table{
	...
	function get_semaforo(){
		...
		var_dump($this->grados,
			isset($this->grados), $this->grados>0,$this->nivel->nombre != "BACHILLERATO" , ($this->grados < 4 * $turnos && $this->nivel->nombre == "PRIMARIA") || ($this->grados < 3 * $turnos && $this->nivel->nombre == "SECUNDARIA") ,
			((isset($this->grados) && $this->grados>0 )&& $this->nivel->nombre != "BACHILLERATO"  && ($this->grados < 4 * $turnos && $this->nivel->nombre == "PRIMARIA") || ($this->grados < 3 * $turnos && $this->nivel->nombre == "SECUNDARIA")) );exit;

		if(isset($this->grados) && $this->grados>0 && $this->nivel->nombre != "BACHILLERATO"  && ($this->grados < 4 * $turnos && $this->nivel->nombre == "PRIMARIA") || ($this->grados < 3 * $turnos && $this->nivel->nombre == "SECUNDARIA") ){
			$this->semaforo = 6;
